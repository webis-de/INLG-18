...
class Model(object):
    ...
    def __init__(self, args, vocab):
        ...
        self.emb_init = tf.placeholder(tf.float32, shape=(vocab.size, dim_emb))
        embedding = tf.Variable(self.emb_init,name='embedding')
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        ...
        if args.train:
            ...
            while epoch < 1+args.max_epochs and patience < args.early_stop:
